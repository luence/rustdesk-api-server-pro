...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  address_book_peers: () => import("@/views/address-book/peers/index.vue"),
  address_book_manage: () => import("@/views/address-book/manage/index.vue"),
  address_book_tags: () => import("@/views/address-book/tags/index.vue"),
  ...
  "my-devices": () => import("@/views/my-devices/index.vue"),
