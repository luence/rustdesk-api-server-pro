...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  "my-devices_peers": () => import("@/views/address-book/peers/index.vue"),
  "my-devices_manage": () => import("@/views/address-book/manage/index.vue"),
  "my-devices_tags": () => import("@/views/address-book/tags/index.vue"),
