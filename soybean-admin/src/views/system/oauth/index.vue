...
async function saveProvider() {
  saving.value = true;
  try {
    const payload = { ...form, clientSecret: form.clientSecret === savedSecretHint.value ? '' : form.clientSecret, scopes: values(form.scopesText), allowedEmailDomains: values(form.allowedDomainsText) };
