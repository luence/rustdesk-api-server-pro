...
const local: App.I18n.Schema = {
  ...
  common: {
    ...
    clear: 'Tout effacer',
    confirmClear: 'Voulez-vous vraiment tout effacer ? Cela invalidera tous les jetons actifs.',
    edit: 'Modifier',
    import: 'Importer CSV',
    export: 'Exporter CSV',
    look: 'Voir',
  ...
  page: {
    ...
    home: {
      ...
      serverConfig: {
        ...
        saveSuccess: 'Configuration du serveur enregistrée avec succès',
    ...
    oauth: {
      ...
      appleSecretHint:
        'Apple utilise un JWT généré dynamiquement comme client_secret. Configurez Team ID, Key ID et Private Key ci-dessous.',
      teamId: 'Team ID',
      keyId: 'Key ID',
  ...
  api: {
    ...
    IdRequired: 'L\'ID est requis',
    Unauthorized: 'Accès non autorisé',
    ProviderNotFound: 'Fournisseur introuvable',
    ProviderDisabled: 'Le fournisseur est désactivé',
    MissingCodeOrState: 'Code d\'autorisation ou état manquant',
    StateInvalidOrExpired: 'L\'état est invalide ou expiré',
    FailedToGenerateState: 'Échec de la génération de l\'état',
    FailedToGenerateTicket: 'Échec de la génération du ticket',
    TicketRequired: 'Le ticket est requis',
    TicketInvalidOrExpired: 'Le ticket est invalide ou expiré',
    OauthTicketUserNotAvailable: 'Utilisateur du ticket OAuth non disponible',
    OauthIssuerRequired: 'L\'émetteur OAuth est requis',
    OauthMetadataMissingRequiredEndpoints: 'Métadonnées OAuth : endpoints requis manquants',
    OauthTokenResponseMissingToken: 'Réponse de jeton OAuth : jeton manquant',
    OauthUserinfoSubjectMismatch: 'Sujet userinfo OAuth incompatible',
    OauthSubjectClaimMissing: 'Claim de sujet OAuth manquant',
    VerifiedGithubEmailRequired: 'E-mail GitHub vérifié requis',
    VerifiedOauthEmailRequired: 'E-mail OAuth vérifié requis',
    EmailDomainNotAllowed: 'Domaine e-mail non autorisé',
    QqOpenidResponseInvalid: 'Réponse QQ OpenID invalide',
    OauthIssuerRequiredForIdToken: 'Émetteur OAuth requis pour l\'ID token',
    OauthJwksUriMissingForIdToken: 'URI JWKS OAuth manquante pour l\'ID token',
    InvalidIdToken: 'ID token invalide',
    BoundAdminUserNotAvailable: 'Administrateur lié non disponible',
    NoBindableOauthAccount: 'Aucun compte OAuth liable',
    FailedToAllocateUniqueUsername: 'Échec de l\'allocation d\'un nom d\'utilisateur unique',
    OauthRedirectUrlMissing: 'URL de redirection OAuth manquante',
    InvalidStateFormat: 'Format d\'état invalide',
    StateSignatureMismatch: 'Signature d\'état incompatible',
    StatePayloadIncomplete: 'Charge utile d\'état incomplète',
    StateExpired: 'État expiré',
    OauthDiscoveryFailedWithStatus: 'Découverte OAuth échouée',
    TokenExchangeFailedWithStatus: 'Échange de jeton échoué',
    QqUserinfoFailedWithRet: 'Échec userinfo QQ',
    QqApiFailedWithStatus: 'Requête API QQ échouée',
    UserinfoFailedWithStatus: 'Requête userinfo échouée',
    AppleClientSecretJwtFailed: 'Échec de génération du JWT client_secret Apple',
    AppleIdTokenClaimMissing: 'ID Token Apple : claims requis manquants',
    InvalidAccountId: 'ID de compte invalide',
    UnsupportedOAuthProvider: 'Fournisseur OAuth non pris en charge',
    InvalidProviderName: 'Nom de fournisseur invalide',
    ClientIdRequired: 'L\'ID client est requis',
    ProviderNameExists: 'Le nom de fournisseur existe déjà',
    ClientSecretRequired: 'Le secret client est requis',
    ProviderNotEnabled: 'Le fournisseur n\'est pas activé',
    ProviderNotEnabledOrIncomplete: 'Fournisseur non activé ou incomplet',
    InvalidRedirectUrl: 'URL de redirection invalide',
    ProviderRequired: 'Le fournisseur est requis',
    IdAndUuidRequired: 'L\'ID et l\'UUID sont requis',
    ProviderNotAvailableForClientLogin: 'Fournisseur non disponible pour la connexion client',
    PollTokenMissingFromState: 'Jeton de sondage manquant dans l\'état',
    PollTokenRequired: 'Le jeton de sondage est requis',
    ClientTicketExpected: 'Ticket client attendu',
    FailedToGeneratePollToken: 'Échec de la génération du jeton de sondage',
    OauthAccountNotBound: 'Compte OAuth non lié',
    OauthProviderUnreachable: 'Fournisseur OAuth inaccessible',
    OauthStateExpired: 'État OAuth expiré',
    OauthProviderNotForClient: 'Fournisseur OAuth non destiné au client',
    OauthAuthFailed: 'Authentification OAuth échouée',
    MissingOp: 'Type d\'opération manquant',
    MissingCode: 'Code manquant',
    NoAuthedOidcIsFound: 'Aucun OIDC autorisé trouvé',
    OidcDisabled: 'OIDC est désactivé',
    OidcFailedToGenerateState: 'Échec de la génération de l\'état OIDC',
    OidcMissingCodeOrState: 'Code ou état OIDC manquant',
    OidcStateInvalidOrExpired: 'État OIDC invalide ou expiré',
    OidcFailedToGenerateTicket: 'Échec de la génération du ticket OIDC',
    OidcTicketRequired: 'Le ticket OIDC est requis',
    OidcTicketInvalidOrExpired: 'Ticket OIDC invalide ou expiré',
    OidcIssuerRequired: 'L\'émetteur OIDC est requis',
    OidcMetadataMissingRequiredEndpoints: 'Métadonnées OIDC : endpoints requis manquants',
    OidcTokenResponseMissingToken: 'Réponse de jeton OIDC : jeton manquant',
    OidcSubjectClaimMissing: 'Claim de sujet OIDC manquant',
    OidcEmailDomainNotAllowed: 'Domaine e-mail OIDC non autorisé',
    OidcInvalidIdToken: 'ID token OIDC invalide',
    OidcIdTokenIssuerInvalid: 'Émetteur de l\'ID token OIDC invalide',
    OidcIdTokenAudienceInvalid: 'Audience de l\'ID token OIDC invalide',
    OidcIdTokenExpired: 'ID token OIDC expiré',
    OidcIdTokenIssuedAtInvalid: 'Date d\'émission de l\'ID token OIDC invalide',
    OidcBoundAdminUserNotAvailable: 'Administrateur lié OIDC non disponible',
    OidcNoBindableAdminAccount: 'Aucun compte admin OIDC liable',
    OidcFailedToAllocateUniqueUsername: 'Échec de l\'allocation d\'un nom d\'utilisateur OIDC unique',
    OidcRedirectUrlMissing: 'URL de redirection OIDC manquante',
    OidcDiscoveryFailedWithStatus: 'Découverte OIDC échouée',
    OidcTokenExchangeFailedWithStatus: 'Échange de jeton OIDC échoué',
    OidcUserinfoFailedWithStatus: 'Requête userinfo OIDC échouée',
    OidcIdTokenKidMissing: 'Kid de l\'ID token OIDC manquant',
    OidcUnsupportedIdTokenAlg: 'Algorithme d\'ID token OIDC non pris en charge',
    OidcJwksUriMissing: 'URI JWKS OIDC manquante',
    OidcJwksFetchFailedWithStatus: 'Récupération JWKS OIDC échouée',
    OidcMatchingJwkNotFound: 'JWK correspondant OIDC introuvable',
    OidcInvalidRsaJwk: 'JWK RSA OIDC invalide',
    OidcInvalidRsaExponent: 'Exposant RSA OIDC invalide',
    OidcNotSupported: 'OIDC non pris en charge',
    OidcQueryNotSupported: 'Requête OIDC non prise en charge',
    TfaValidateErr: 'Erreur de validation 2FA',
    NoUserIds: 'Aucun ID utilisateur sélectionné',
    AddressBookNotFound: 'Carnet d\'adresses introuvable',
    NameRequired: 'Le nom est requis',
    TagAlreadyExists: 'L\'étiquette existe déjà',
    TagNotFound: 'Étiquette introuvable',
    OldAndNewRequired: 'L\'ancien et le nouveau nom sont requis',
    DeviceIdRequired: 'L\'ID de l\'appareil est requis',
    PeerNotFound: 'Pair introuvable',
    UserNotFound: 'Utilisateur introuvable',
    PersonalAddressBookReadOnly: 'Le carnet d\'adresses personnel est en lecture seule',
    PersonalAddressBookCannotBeDeleted: 'Le carnet d\'adresses personnel ne peut pas être supprimé',
    AdminCreatedAddressBookCannotBeDeletedByUser: 'Le carnet d\'adresses créé par un admin ne peut pas être supprimé par un utilisateur',
    InvalidRule: 'Règle invalide',
    TargetTypeAndTargetGuidRequired: 'Le type cible et le GUID cible sont requis',
    GuidAndTargetRequired: 'Le GUID et la cible sont requis',
    RuleNotFound: 'Règle introuvable',
    NoPeerIds: 'Aucun ID de pair sélectionné',
    NoTagNames: 'Aucun nom d\'étiquette sélectionné',
    NumberOfEquipmentInExcessOfLicenses: 'Le nombre d\'appareils dépasse les licences',
    RuleMustBe1Or2Or3: 'La règle doit être 1, 2 ou 3',
    ExceedMaxDevices: 'Dépasse le nombre maximal d\'appareils',
    DeviceGroupNotFound: 'Groupe d\'appareils introuvable',
    UserGroupNotFound: 'Groupe d\'utilisateurs introuvable',
    StrategyNotFound: 'Stratégie introuvable',
    StrategyGuidRequired: 'Le GUID de stratégie est requis',
    DeviceNotFound: 'Appareil introuvable',
    UserRequired: 'L\'utilisateur est requis',
    InvalidInput: 'Entrée invalide',
    NotEnabled: 'Fonctionnalité non activée',
    TypeRequired: 'Le type est requis',
    FileRequired: 'Le fichier est requis',
    InvalidOffset: 'Décalage invalide',
    UnsupportedRecordOp: 'Opération d\'enregistrement non prise en charge',
    InvalidRecordWriteSize: 'Taille d\'écriture d\'enregistrement invalide',
    RecordFileExceedsMaxSize: 'Le fichier d\'enregistrement dépasse la taille maximale',
    MailTemplateNotFoundOrError: 'Modèle de courriel introuvable ou erreur',
    SmtpConnectionFailed: 'Échec de la connexion SMTP',
    MailSendFailed: 'Échec de l\'envoi du courriel',
    NoSessionIds: 'Aucun ID de session sélectionné',
    NoTokenIds: 'Aucun ID de jeton sélectionné',
    InvalidConnectivityTarget: 'Cible de connectivité invalide',
    EmptyTarget: 'Cible vide',
    EmptyHost: 'Hôte vide',
    InvalidUrl: 'URL invalide',
    KeyIsEmpty: 'La clé API est vide',
    DbEngineIsNil: 'Le moteur de base de données est nil',
    UnsafeSignKey: 'Clé de signature non sécurisée',
    JobDbEngineIsNil: 'Le moteur de base de données des jobs est nil',
    InvalidDeviceCheckJobDuration: 'Durée du job de vérification d\'appareil invalide',
    CreateSchedulerFailed: 'Échec de la création du planificateur',
    CreateDeviceCheckJobFailed: 'Échec de la création du job de vérification d\'appareil',
    DatabaseError: 'Erreur de base de données',
    OnlySupportHttpHttpsSocks5ProxyProtocols: 'Seuls les protocoles proxy HTTP/HTTPS/SOCKS5 sont pris en charge',
    HttpResponseTooLarge: 'Réponse HTTP trop volumineuse',
    HttpGetFailedWithStatus: 'Requête HTTP GET échouée',
    DownloadFailedWithStatus: 'Téléchargement échoué',
    DownloadTooLarge: 'Téléchargement trop volumineux',
    EmptyZipEntryName: 'Nom d\'entrée ZIP vide',
    ZipEntryIsASymlink: 'L\'entrée ZIP est un lien symbolique',
    ZipEntryUsesAbsolutePath: 'L\'entrée ZIP utilise un chemin absolu',
    ZipEntryEscapesDestination: 'L\'entrée ZIP échappe la destination',
    UnsupportedOperatingSystem: 'Système d\'exploitation non pris en charge',
    HbbrStartError: 'Erreur de démarrage HBBR',
    HbbsStartError: 'Erreur de démarrage HBBS',
    WriteHbbrPidFileError: 'Erreur d\'écriture du fichier PID HBBR',
    WriteHbbsPidFileError: 'Erreur d\'écriture du fichier PID HBBS',
    GetReleasesRequestFailed: 'Requête de récupération des releases échouée',
    DecodeReleasesResponseFailed: 'Échec du décodage de la réponse des releases',
    GetLatestReleaseRequestFailed: 'Requête de récupération de la dernière release échouée',
    DecodeLatestReleaseResponseFailed: 'Échec du décodage de la réponse de la dernière release',
    GetReleaseByTagRequestFailed: 'Requête de récupération de release par tag échouée',
    DecodeReleaseByTagResponseFailed: 'Échec du décodage de la réponse de release par tag',
    GuidRequired: 'Le GUID est requis'
  }
};
