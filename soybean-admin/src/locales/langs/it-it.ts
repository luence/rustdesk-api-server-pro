const local: App.I18n.Schema = {
  ...
  page: {
    ...
    home: {
      ...
      cardDetail: {
        viewHint: 'Clicca per vedere i dettagli',
        recentUsers: 'Utenti recenti',
        recentDevices: 'Dispositivi recenti',
        recentVisits: 'Log di accesso recenti',
        desc: {
          userCount: 'Mostra il numero totale di utenti nel sistema.',
          deviceCount: 'Mostra il numero totale di dispositivi nel sistema.',
          onlineCount: 'Mostra i dispositivi online in base alle statistiche heartbeat.',
          visitCount: 'Mostra le statistiche visite dai log di audit.'
        }
      },
      serverConfig: {
  ...
  dataMap: {
    ...
    ab: {
      ...
      personal: 'La mia rubrica', legacy: 'Rubrica legacy', note: 'Nota', platform: 'Piattaforma', personalReadOnly: 'Personale (sola lettura)', nameRequired: 'Il nome è obbligatorio', deviceIdRequired: 'L’ID dispositivo è obbligatorio', tagsHint: 'Separa le etichette con virgole', read: 'Lettura', readWrite: 'Lettura e scrittura', fullControl: 'Controllo completo'
    },
    token: {
