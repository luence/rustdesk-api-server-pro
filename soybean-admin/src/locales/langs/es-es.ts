...
const local: App.I18n.Schema = {
  ...
  page: {
    ...
    oauth: {
      configTitle: 'Configuración de inicio de sesión externo', bindingsTitle: 'Vinculaciones de cuentas', addProvider: 'Añadir proveedor', editProvider: 'Editar proveedor', providerName: 'Clave del proveedor', displayName: 'Nombre visible', clientId: 'ID de cliente', clientSecret: 'Secreto de cliente', secretPlaceholder: 'Déjelo vacío para conservar el secreto configurado', redirectUrl: 'URL de retorno', scopes: 'Ámbitos', accountRole: 'Rol de la cuenta', allowedDomains: 'Dominios de correo permitidos', bindByEmail: 'Vincular por correo verificado', autoCreateAdmin: 'Crear administrador automáticamente', autoCreateUser: 'Crear usuario automáticamente', testConfig: 'Probar configuración', testSuccess: 'Configuración completa y URL de autorización generada', copyCallback: 'Copiar URL de retorno', githubOnlyTip: 'GitHub está disponible primero. Configúrelo aquí; server.yaml queda para compatibilidad y recuperación.', adminRole: 'Administrador', userRole: 'Usuario', useDefault: 'Usar valor predeterminado', listPlaceholder: 'Separe varios valores con espacios o comas', copied: 'Copiado'
    },
    about: {
      ...enUs.page.about,
